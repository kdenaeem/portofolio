// client component, we can interact with use state use effect. Any interactive component will be a client component
// 
"use client";
...
import {useActiveSectionContext} from '../context/active_context';

export default function Header() {
  // active function and setter function

  // it will never be null because we have checked it
  ...
  return (
    <header className='z-[999] relative'>
      <motion.div className='fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border border-white border-opacity-40
       ...
       backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full' initial={{y : -100, x:"-50%", opacity: 0}} animate={{ y: 0, x: "-50%", opacity: 1}}>
