...
export default function Project({
  ...
  const opacityProgressTransform = useTransform(
    scrollYProgress,
    [0, 1],
    [0.8, 1]
  );
  ...
  return (
    ...
    <motion.div
      ref={ref}
      style={{ scale: scaleTransform, opacity: opacityProgressTransform }}
      className="group mb-3 sm:mb-8 last:mb-0"
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem]  even:pl-8 hover:bg-gray-200 hover:scale-105 transition group-even:pl-8 rounded-lg">
